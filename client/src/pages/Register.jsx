  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-[#0a0a0a] relative overflow-hidden p-4">
      ...
      <div className="absolute top-0 w-full h-full overflow-hidden pointer-events-none flex justify-center items-center">
        <div className="absolute w-[800px] h-[800px] bg-emerald-500/10 dark:bg-emerald-500/5 rounded-full blur-3xl -translate-y-1/2 opacity-50"></div>
        <div className="absolute w-[600px] h-[600px] bg-blue-500/10 dark:bg-blue-500/5 rounded-full blur-3xl translate-x-1/3 translate-y-1/3 opacity-50"></div>
      </div>
      ...
      >
        <div className="bg-white/80 dark:bg-[#121212]/80 backdrop-blur-xl border border-zinc-200/50 dark:border-white/10 rounded-2xl shadow-xl p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-semibold text-zinc-700 dark:text-zinc-300 uppercase tracking-wider mb-2">Full Name</label>
              <input 
                type="text" 
                className="w-full bg-white dark:bg-[#0a0a0a] border border-zinc-300 dark:border-white/10 rounded-xl px-4 py-3 text-sm text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all placeholder:text-zinc-400"
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-700 dark:text-zinc-300 uppercase tracking-wider mb-2">Password</label>
              <input 
                type="password" 
                className="w-full bg-white dark:bg-[#0a0a0a] border border-zinc-300 dark:border-white/10 rounded-xl px-4 py-3 text-sm text-zinc-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 transition-all placeholder:text-zinc-400"
                placeholder="••••••••"
